                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 15.0, 0.0, 0.0),
                                          child: Text(
                                            'FitZone team of dedicated fitness experts, nutritionists, and wellness coaches are committed to providing evidence-based information and cutting-edge resources to help you achieve your goals. We strive to be your go-to resource for all things fitness, fostering a welcoming and supportive community where individuals of all fitness levels can connect, share their experiences, and celebrate achievements.\n',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Noto Sans',
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 25.0, 0.0, 10.0),
                                          child: Text(
                                            'we measure our success by the transformations and success stories of our users. Your progress is our motivation, and we are genuinely invested in your success. Join our community and experience the power of collective motivation on your journey to a healthier and happier you.\n',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Noto Sans',
